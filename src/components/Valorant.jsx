function Valorant() {
  return (
    <div className="font-sans bg-black text-white">
      ...
      <section
        id="agents"
        className="px-6 md:px-16 py-20 bg-zinc-950"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-zinc-900 border border-zinc-800 p-8 hover:border-red-600 transition">
            ...
            <p className="text-zinc-400 text-sm">
              Defensive experts who watch flanks, plant traps, and hold down
              the fort.
            </p>
      ...
      <section
        id="ranked"
        className="px-6 md:px-16 py-20 bg-red-600 text-white"
      >
